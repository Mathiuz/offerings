...
###Build Offering Core for Linux, Windows, and OS X:
...
- Update bitcoin.org version
  ...
  - First, check to see if the Offering.org maintainers have prepared a
  ...
  - If they have not prepared a release, follow the Offering.org release
...
- Announce the release:
  ...
  - Offering-development mailing list

  - Update title of #bitcoin on Freenode IRC

  - Optionally reddit /r/Offering, ... but this will usually sort out itself
