...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Offering Core"),
     ...
     * override -datadir in the offeringcoin.conf file in the default data directory
     * (to be consistent with offeringd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
